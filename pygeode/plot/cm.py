...
hsv_div = {4: ([0.35, 0.4, 0.5, -0.556, -1.0, 0.94, 0.87, 0.82], [0.96, 0.4], [0.4, 0.7]), \
           3: ([0.4, 0.5, -0.556, -1.0, 0.94, 0.87], [0.96, 0.4], [0.4, 0.7]), \
           2: ([0.5, -0.556, -1.0, 0.94], [0.96, 0.4], [0.4, 0.7]), \
           1: ([-0.556, -1.0], [0.96, 0.4], [0.4, 0.7])}
hsv_seq = {6: ([0.5, 0.556, 1.0, 0.94, 0.87, 0.82], [0.96, 0.4], [0.4, 0.7]), \
           5: ([0.5, 0.556, 1.0, 0.94, 0.87], [0.96, 0.4], [0.4, 0.7]), \
           4: ([0.5, 0.556, 1.0, 0.94], [0.96, 0.4], [0.4, 0.7]), \
